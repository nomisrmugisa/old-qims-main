            ...
            <div className="col-lg-8 text-center">
              ...
              <a
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 8,
                  padding: '12px 38px', // Adjusted padding for better vertical centering
                  fontSize: '1.15rem',
